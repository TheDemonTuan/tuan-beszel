...
- Heartbeat Worker/D1 và UptimeFlare: chưa triển khai vì Cloudflare token được cung cấp thiếu quyền ghi D1/Workers; token đã lộ trong chat, cần revoke thủ công rồi tạo token mới.
